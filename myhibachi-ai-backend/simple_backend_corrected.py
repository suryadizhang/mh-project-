...
FAQ_DATA = [
    {
        ...
        "category": "service",
        "keywords": ["included", "service", "what comes with", "hibachi service", "equipment", "cleanup", "tables", "chairs"]
    },
    {
        "id": "2", 
        ...
        "keywords": ["sacramento", "serve", "area", "travel", "northern california", "roseville", "folsom", "davis"]
    },
    {
        "id": "3",
        ...
        "category": "pricing",
        "keywords": ["deposit", "cost", "price", "refundable", "100", "hundred", "booking", "terms", "conditions"]
    },
    {
        "id": "4",
        ...
        "category": "menu",
        "keywords": ["proteins", "chicken", "beef", "steak", "shrimp", "salmon", "tofu", "vegetarian", "meat", "options"]
    },
    {
        "id": "5",
        ...
        "category": "service_area",
        "keywords": ["service area", "bay area", "san francisco", "san jose", "oakland", "palo alto", "mountain view", "santa clara", "sunnyvale", "fremont", "travel fee"]
    },
    {
        "id": "6",
...
"""
        ...
        return "I'm having trouble accessing my knowledge right now. Please contact our team directly for assistance.", 0.2
...
async def chat(request: ChatRequest):
    try:
        ...
        context = ""
        if faq_results:
            context = f"Related FAQs: {'; '.join([f'{r['question']}: {r['answer'][:100]}...' for r in faq_results[:2]])}"
