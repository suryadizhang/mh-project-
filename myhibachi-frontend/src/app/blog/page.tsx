    ...
    <div className="min-h-screen">
      ...
      <section className="page-hero-background py-20 text-white text-center">
        <div className="max-w-4xl mx-auto px-4">
          <h1 className="text-5xl font-bold mb-6">MyHibachi Blog</h1>
          <p className="text-xl mb-8 text-gray-200">Stories, tips, and insights from the world of hibachi catering</p>
          <div className="text-lg">
            <span className="bg-orange-600 text-white px-4 py-2 rounded-full">Latest Updates & Tips</span>
          </div>
        </div>
      </section>
