...
export default function BlogPage() {
  ...
  const filteredPosts = useMemo(() => {
    return allPosts.filter(post => {
      ...
      // Event sizes filter
      if (filters.eventSizes.length > 0 && !filters.eventSizes.some(size =>
  ...
  const paginatedAllPosts = allPostsExceptFeatured.slice(startAllPostsIndex, startAllPostsIndex + POSTS_PER_PAGE)
    ...
    <div className="min-h-screen bg-white" data-page="blog">
      ...
      <section className="bg-slate-50 border-b border-slate-200">
        <div className="max-w-4xl mx-auto px-4 py-16 text-center">
          ...
          <p className="text-lg text-slate-600 mb-8 max-w-2xl mx-auto">
            Professional insights, culinary expertise, and event planning guidance for premium hibachi catering
          </p>
        </div>
      </section>
      ...
      <div className="max-w-6xl mx-auto px-4 pb-16">
        {!hasActiveFilters && !showAllPosts ? (
          ...
          <div>
            ...
            <section className="mb-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {allPosts.filter(post => post.featured).slice(0, 3).map((post) => (
                    ...
                    <article className="blog-card group bg-white border border-slate-200 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 cursor-pointer">
                      ...
                      <div className="p-6">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <span className="blog-read-more-inline">
                            Read More →
                          </span>
                        </div>
                      </div>
          ...
          /* Filtered Results */
          <div className="bg-white rounded-lg border border-slate-200 shadow-sm p-8" data-results-section>
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-2xl font-bold text-slate-900">
            ...
            {paginatedPosts.length > 0 ? (
              ...
              <div className="text-center py-12">
                <div className="text-slate-500 text-lg mb-4">No posts found matching your filters</div>
                <p className="text-slate-400">Try adjusting your search terms or removing some filters</p>
              </div>
            )}
          </div>
        )}
