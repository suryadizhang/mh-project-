        ...
        <div className="container">
          ...
          <div className="row services-grid">
            <div className="col-md-4 mb-4">
              <div className="service-card">
                ...
                <div className="service-features">
                  <span className="feature-badge">🎂 Birthday Parties</span>
                  <span className="feature-badge">💑 Anniversary Dinners</span>
                  <span className="feature-badge">👨‍👩‍👧‍👦 Family Reunions</span>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-4 mb-4">
              <div className="service-card">
                <div className="service-icon-wrapper">
                  <i className="bi bi-briefcase service-icon-bi"></i>
                </div>
                ...
                <div className="service-features">
                  ...
                  <span className="feature-badge">🎯 Client Events</span>
                  <span className="feature-badge">🏆 Company Celebrations</span>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-4 mb-4">
              <div className="service-card">
                <div className="service-icon-wrapper">
                  <i className="bi bi-heart service-icon-bi"></i>
                </div>
                ...
                <div className="service-features">
                  ...
                  <span className="feature-badge">🎓 Graduations</span>
                  <span className="feature-badge">🎊 Holiday Parties</span>
                </div>
              </div>
            </div>
          </div>
