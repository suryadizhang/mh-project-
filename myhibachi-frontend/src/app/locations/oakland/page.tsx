...
export const metadata: Metadata = {
  ...
  keywords:
    'Oakland hibachi catering, hibachi chef Oakland, Oakland party catering, hibachi catering near Oakland, private chef Oakland, Japanese catering Oakland, hibachi birthday party Oakland, Oakland wedding hibachi, East Bay hibachi',
  openGraph: {
    title: locationData.title,
    description: locationData.metaDescription,
    type: 'website',
            ...
            {locationData.content.services.map((service, index) => (
              <div key={index} className="bg-white p-6 rounded-lg shadow-sm text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Professional hibachi entertainment for your Oakland celebration
                </p>
              </div>
            ))}
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div
            ...
            dangerouslySetInnerHTML={{
              __html: locationContentBlocks.whyChooseUs('Oakland').replace(/\n/g, '<br />')
            }}
          />
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4">
          <div
            className="prose prose-lg max-w-none"
            dangerouslySetInnerHTML={{
              __html: locationContentBlocks.popularEvents('Oakland').replace(/\n/g, '<br />')
            }}
          />
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4">
          <div
            className="prose prose-lg max-w-none"
            dangerouslySetInnerHTML={{
              __html: locationContentBlocks.serviceAreas('Oakland').replace(/\n/g, '<br />')
            }}
          />
        </div>
      </section>
