...
const locationData = generateLocationPage('Santa Clara')

export const metadata: Metadata = {
  title: locationData.title,
  description: locationData.metaDescription,
  keywords: 'Santa Clara hibachi catering, hibachi chef Santa Clara, Santa Clara University hibachi, Silicon Valley hibachi catering, tech company hibachi Santa Clara, Santa Clara party catering, corporate hibachi Santa Clara, SCU hibachi',
  openGraph: {
    title: locationData.title,
    description: locationData.metaDescription,
    type: 'website',
  ...
  alternates: {
    canonical: '/locations/santa-clara'
  }
}

export default function SantaClaraHibachiPage() {
  return (
    <div className="min-h-screen">
      {/* Schema Markup */}
      <LocalBusinessSchema
        businessName="MyHibachi Santa Clara"
        location="Santa Clara"
        description="Professional hibachi catering service in Santa Clara, California - Silicon Valley University hibachi entertainment"
      />
      ...
      <section className="page-hero-background py-20 text-white text-center">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            >
              Book Santa Clara Hibachi Catering
            </Link>
            <Link
              href="/contact"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {locationData.content.services.map((service, index) => (
              <div key={index} className="bg-white p-6 rounded-lg shadow-sm text-center">
                ...
                <p className="text-gray-600 text-sm">Professional hibachi entertainment for your Santa Clara celebration</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4">
          <div className="prose prose-lg max-w-none"
               dangerouslySetInnerHTML={{ __html: locationContentBlocks.whyChooseUs('Santa Clara').replace(/\n/g, '<br />') }} />
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4">
          <div className="prose prose-lg max-w-none"
               dangerouslySetInnerHTML={{ __html: locationContentBlocks.popularEvents('Santa Clara').replace(/\n/g, '<br />') }} />
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4">
          <div className="prose prose-lg max-w-none"
               dangerouslySetInnerHTML={{ __html: locationContentBlocks.serviceAreas('Santa Clara').replace(/\n/g, '<br />') }} />
        </div>
      </section>
      ...
      <section className="py-16 bg-orange-600 text-white text-center">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-3xl font-bold mb-6">
            Ready to Book Your Santa Clara Hibachi Experience?
          </h2>
          <p className="text-xl mb-8">
            Contact us today for a free quote on your Santa Clara hibachi catering event!
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link
              href="/booking"
      ...
      <Assistant page="/locations/santa-clara" />
    </div>
  )
}
