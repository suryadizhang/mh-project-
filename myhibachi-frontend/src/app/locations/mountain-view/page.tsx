...
const locationData = generateLocationPage('Mountain View')
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: '/locations/mountain-view'
  }
}

export default function MountainViewHibachiPage() {
  return (
    <div className="min-h-screen">
      {/* Schema Markup */}
      <LocalBusinessSchema
        businessName="MyHibachi Mountain View"
        location="Mountain View"
        description="Professional hibachi catering service in Mountain View, California - Silicon Valley's premier tech company hibachi entertainment"
      />
      ...
      <section className="page-hero-background py-20 text-white text-center">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            >
              Book Mountain View Hibachi Catering
            </Link>
            <Link
              href="/contact"
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
            Mountain View Hibachi Catering Services
          </h2>
      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
            What Mountain View Customers Say
          </h2>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
            Mountain View Hibachi Catering FAQ
          </h2>
      ...
      <section className="py-16 bg-orange-600 text-white text-center">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-3xl font-bold mb-6">
            Ready to Book Your Mountain View Hibachi Experience?
          </h2>
          <p className="text-xl mb-8">
            Contact us today for a free quote on your Mountain View hibachi catering event!
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link
              href="/booking"
      ...
      <Assistant page="/locations/mountain-view" />
    </div>
  )
}
