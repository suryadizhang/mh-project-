...
export const metadata: Metadata = {
  ...
  keywords:
    'Sacramento hibachi catering, hibachi chef Sacramento, Capitol area hibachi, Sacramento party catering, Northern California hibachi, Sacramento birthday hibachi, wedding hibachi Sacramento, corporate hibachi Sacramento',
  openGraph: {
    title: locationData.title,
    description: locationData.metaDescription,
    type: 'website',
            ...
            {locationData.content.services.map((service, index) => (
              <div key={index} className="bg-white p-6 rounded-lg shadow-sm text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Professional hibachi entertainment for your Sacramento celebration
                </p>
              </div>
            ))}
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div
            ...
            dangerouslySetInnerHTML={{
              __html: locationContentBlocks.whyChooseUs('Sacramento').replace(/\n/g, '<br />')
            }}
          />
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4">
          <div
            className="prose prose-lg max-w-none"
            dangerouslySetInnerHTML={{
              __html: locationContentBlocks.popularEvents('Sacramento').replace(/\n/g, '<br />')
            }}
          />
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4">
          <div
            className="prose prose-lg max-w-none"
            dangerouslySetInnerHTML={{
              __html: locationContentBlocks.serviceAreas('Sacramento').replace(/\n/g, '<br />')
            }}
          />
        </div>
      </section>
