...
const locationData = generateLocationPage('Sacramento')

export const metadata: Metadata = {
  title: locationData.title,
  description: locationData.metaDescription,
  keywords: 'Sacramento hibachi catering, hibachi chef Sacramento, Capitol area hibachi, Sacramento party catering, Northern California hibachi, Sacramento birthday hibachi, wedding hibachi Sacramento, corporate hibachi Sacramento',
  openGraph: {
    title: locationData.title,
    description: locationData.metaDescription,
    type: 'website',
  ...
  alternates: {
    canonical: '/locations/sacramento'
  }
}

export default function SacramentoHibachiPage() {
  return (
    <div className="min-h-screen">
      {/* Schema Markup */}
      <LocalBusinessSchema
        businessName="MyHibachi Sacramento"
        location="Sacramento"
        description="Professional hibachi catering service in Sacramento, California - Northern California's premier hibachi entertainment"
      />
      ...
      <section className="page-hero-background py-20 text-white text-center">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            >
              Book Sacramento Hibachi Catering
            </Link>
            <Link
              href="/contact"
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
            Sacramento Hibachi Catering Services
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {locationData.content.services.map((service, index) => (
              <div key={index} className="bg-white p-6 rounded-lg shadow-sm text-center">
                <h3 className="text-lg font-semibold text-gray-900 mb-2">{service}</h3>
                <p className="text-gray-600 text-sm">Professional hibachi entertainment for your Sacramento celebration</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4">
          <div className="prose prose-lg max-w-none"
               dangerouslySetInnerHTML={{ __html: locationContentBlocks.whyChooseUs('Sacramento').replace(/\n/g, '<br />') }} />
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4">
          <div className="prose prose-lg max-w-none"
               dangerouslySetInnerHTML={{ __html: locationContentBlocks.popularEvents('Sacramento').replace(/\n/g, '<br />') }} />
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4">
          <div className="prose prose-lg max-w-none"
               dangerouslySetInnerHTML={{ __html: locationContentBlocks.serviceAreas('Sacramento').replace(/\n/g, '<br />') }} />
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
            Sacramento Hibachi Catering FAQ
          </h2>
      ...
      <section className="py-16 bg-orange-600 text-white text-center">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-3xl font-bold mb-6">
            Ready to Book Your Sacramento Hibachi Experience?
          </h2>
          <p className="text-xl mb-8">
            Contact us today for a free quote on your Sacramento hibachi catering event!
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link
              href="/booking"
      ...
      <Assistant page="/locations/sacramento" />
    </div>
  )
}
