...
export const metadata: Metadata = {
  ...
  keywords: 'Sunnyvale hibachi catering, hibachi chef Sunnyvale, Silicon Valley hibachi, tech family hibachi Sunnyvale, private hibachi chef Sunnyvale, Sunnyvale party catering, family hibachi Sunnyvale, backyard hibachi Sunnyvale',
  openGraph: {
    title: locationData.title,
    description: locationData.metaDescription,
    type: 'website',
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {locationData.content.services.map((service, index) => (
              <div key={index} className="bg-white p-6 rounded-lg shadow-sm text-center">
                ...
                <p className="text-gray-600 text-sm">Professional hibachi entertainment for your Sunnyvale celebration</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4">
          <div className="prose prose-lg max-w-none"
               dangerouslySetInnerHTML={{ __html: locationContentBlocks.whyChooseUs('Sunnyvale').replace(/\n/g, '<br />') }} />
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4">
          <div className="prose prose-lg max-w-none"
               dangerouslySetInnerHTML={{ __html: locationContentBlocks.popularEvents('Sunnyvale').replace(/\n/g, '<br />') }} />
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4">
          <div className="prose prose-lg max-w-none"
               dangerouslySetInnerHTML={{ __html: locationContentBlocks.serviceAreas('Sunnyvale').replace(/\n/g, '<br />') }} />
        </div>
      </section>
