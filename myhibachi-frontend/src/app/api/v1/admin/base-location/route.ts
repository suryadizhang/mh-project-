 ...
 *
 * OLD: /v1/admin/base-location
 * NEW: ${NEXT_PUBLIC_API_URL}/api/v1/admin/base-location
 *
 * This stub returns HTTP 410 Gone to indicate permanent migration.
 * Update your frontend code to use the new backend endpoint.
 *
 * Migration Date: 2025-09-02T05:45:43.900Z
 * Backend Route: FastAPI backend - /api/v1/admin/base-location
 */
  ...
  return NextResponse.json(
    {
      ...
      migration: {
        from: '/v1/admin/base-location',
        to: `${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8000'}/api/v1/admin/base-location`,
        status: 'MIGRATED',
