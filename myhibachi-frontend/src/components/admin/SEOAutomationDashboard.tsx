  ...
  const runAutomation = async () => {
    ...
    try {
      ...
      setStats({
        ...
        emailSequences: (updatedData.emailCampaigns as number) || stats.emailSequences,
        trackingKeywords: (updatedData.activeKeywords as number) || stats.trackingKeywords,
        lastRun: new Date().toISOString(),
        automationStatus: 'active'
      })
  ...
  return (
    <div className="container mx-auto p-6 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Directory Submissions</CardTitle>
            <span className="text-2xl">🏢</span>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{stats.directorySubmissions}</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Select a location to run automation tasks</CardDescription>
          </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Comprehensive SEO and marketing automation capabilities</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="p-4 border rounded-lg space-y-2">
              ...
              <p className="text-sm text-gray-600">Content generation for Instagram and Facebook</p>
              <ul className="text-xs text-gray-500 space-y-1">
            ...
            <div className="p-4 border rounded-lg space-y-2">
              ...
              <p className="text-sm text-gray-600">Keyword tracking and position monitoring</p>
              <ul className="text-xs text-gray-500 space-y-1">
