...
export function BaseLocationManager() {
  ...
  const loadCurrentSettings = async () => {
    try {
      const response = await fetch('/api/v1/admin/company-settings')
      if (response.ok) {
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => handleInputChange('baseFeeStructure.freeRadius', parseInt(e.target.value) || 0)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
                <p className="text-xs text-gray-500 mt-1">Distance from base location with no travel fee</p>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => handleInputChange('baseFeeStructure.ratePerMile', parseFloat(e.target.value) || 0)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              ...
              <div className="p-3 bg-blue-50 rounded-lg">
                ...
                <div className="text-sm text-blue-800 space-y-1">
                  <p>• 0-{formData.baseFeeStructure.freeRadius} miles: <strong>Free</strong></p>
                  <p>• Beyond {formData.baseFeeStructure.freeRadius} miles: <strong>${formData.baseFeeStructure.ratePerMile}/mile</strong></p>
                  <p>• Example 50 miles: ${Math.max(0, (50 - formData.baseFeeStructure.freeRadius) * formData.baseFeeStructure.ratePerMile)}</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => handleInputChange('serviceArea.maxRadius', parseInt(e.target.value) || 150)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
                <p className="text-xs text-gray-500 mt-1">Maximum distance from base location served</p>
              </div>
    ...
    <div className="space-y-4">
      ...
      {distance > 0 && (
        <div className="p-3 bg-gray-50 rounded-lg text-sm text-gray-700">
          <strong>Calculation:</strong> {distance <= settings.baseFeeStructure.freeRadius ? 
