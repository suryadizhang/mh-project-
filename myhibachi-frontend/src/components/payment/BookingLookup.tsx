...
export default function BookingLookup({ onBookingFound, isLoading, setIsLoading }: BookingLookupProps) {
    ...
    <div className="bg-white rounded-xl shadow-lg p-6">
      ...
      <div className="mb-4">
        ...
        <div className="flex space-x-2">
          <input
            ...
            placeholder={searchType === 'booking-id' ? 'e.g., MH-20250830-AB12' : 'Enter email or customer name'}
        ...
        <div className="mt-4 p-4 bg-green-50 border border-green-200 rounded-lg">
          ...
          <div className="grid grid-cols-1 gap-2 text-sm text-green-800">
            <div className="flex items-center">
              ...
              <span>{foundBooking.eventDate} at {foundBooking.eventTime}</span>
            </div>
            <div className="flex items-center">
          ...
          <div className="mt-3 pt-3 border-t border-green-200">
            <div className="text-xs text-green-600 uppercase tracking-wide mb-1">Payment Status</div>
            ...
            <div className="flex justify-between items-center mt-1">
              ...
              <span className="text-sm font-medium">${foundBooking.remainingBalance.toFixed(2)}</span>
            </div>
          </div>
        </div>
      )}
      ...
      <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
        ...
        <div className="text-xs text-blue-700 space-y-1">
          <div>• <code className="bg-blue-100 px-1 rounded">MH-20250830-AB12</code> - No deposit paid</div>
          <div>• <code className="bg-blue-100 px-1 rounded">MH-20250825-CD34</code> - Deposit paid</div>
          <div>• <code className="bg-blue-100 px-1 rounded">MH-20250828-EF56</code> - Deposit paid</div>
        </div>
