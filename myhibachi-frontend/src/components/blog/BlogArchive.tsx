  ...
  const archiveData = useMemo(() => {
    ...
    const yearlyArchives: YearlyArchive[] = Object.keys(grouped)
      .map(yearStr => {
        ...
        const months = Object.values(grouped[year])
      ...
      <div className="p-6">
        ...
        <div className="space-y-3">
          {archiveData.map((yearData) => (
            <div key={yearData.year} className="border-b border-gray-100 last:border-b-0 pb-3 last:pb-0">
              {/* Year Header */}
                  ...
                  {yearData.months.map((monthData) => (
                    <div key={monthData.month} className="flex items-center justify-between">
                      ...
                      <div className="text-xs text-gray-400">
                        {monthData.posts.slice(0, 2).map(post => post.title.slice(0, 20)).join(', ')}
