...
const filesToFix = [
  // Booking components
  {
    ...
    replacements: [
      {
        search:
          /console\.warn\('Could not fetch booked dates, continuing without blocking dates'\)/g,
        replace:
      ...
      {
        search:
          /console\.warn\('Could not fetch availability, using default slots'\)/g,
        replace:
      ...
      {
        search:
          /console\.warn\('Could not verify slot availability:', error\)/g,
...

  {
    ...
    replacements: [
      {
        search:
          /console\.log\('FAQ Feedback:', \{ faq_id: faq\.id, helpful, category: faq\.category \}\)/g,
        replace:
...

  {
    ...
    replacements: [
      {
        search:
          /console\.log\('Legacy Assistant component rendered for page:', page\)/g,
        replace:
...

  {
    ...
    replacements: [
      ...
      {
        search:
          /console\.log\('Facebook SDK loaded successfully with App ID:', appId\)/g,
