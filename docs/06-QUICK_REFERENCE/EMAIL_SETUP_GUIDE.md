...
- **IONOS (cs@myhibachichef.com)**: Official external/customer-facing
  emails (provided by IONOS webmail)
- **Gmail (myhibachichef@gmail.com)**: Internal admin communications
  only (free Gmail account)

**Note**: These are the only two emails in use. No other email
accounts are needed.
