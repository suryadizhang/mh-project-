...
from models.base import (
    Base,  # Use same Base as majority of models (User, Booking, Payment, etc.)
)
...
class SystemEvent(Base):
    ...
    __table_args__ = (
        ...
        Index(
            "ix_system_events_entity_lookup",
            "entity_type",
            "entity_id",
            "timestamp",
        ),
        ...
        Index(
            "ix_system_events_service_action", "service", "action", "timestamp"
        ),
