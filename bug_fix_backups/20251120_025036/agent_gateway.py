...
class StationAwareAgentGatewayService:
        ...
        try:
            ...
            if user_station_context:
                user_permissions = set(
                    user_station_context.get("station_permissions", [])
                )
                required_permissions = set(
                    config["required_station_permissions"]
                )
                ...
                if missing_permissions:
                    permission_check = {
                        ...
                        "station_id": user_station_context.get(
                            "current_station_id"
                        ),
                    }
    ...
    async def process_station_aware_request(
        ...
        try:
            ...
            validation = await self.validate_agent_for_station_user(
                agent, user_station_context
            )
            ...
            namespace_context = (
                await self.namespace_service.create_agent_context(
            ...
            agent_context = {
                ...
                "station_context": {
                    ...
                    "station_permissions": user_station_context.get(
                        "station_permissions", []
                    ),
                    "data_access_level": agent_config["station_data_access"],
                    "is_super_admin": user_station_context.get(
            ...
            tool_validation = (
                await self.tool_registry.validate_tools_with_station_context(
            ...
            return {
                ...
                "cost": {
                    "input_tokens": response_data[3]
                    * 0.00001,  # Simplified cost calc
            ...
            logger.exception(
                f"Station-aware agent gateway processing error: {e}"
            )
    ...
    async def _handle_permission_denied_error(
        ...
        return {
            ...
            "station_context": {
                ...
                "required_permissions": permission_check[
                    "missing_permissions"
                ],
    ...
    async def _get_available_actions_with_station(
        ...
        if agent_type == AgentType.CUSTOMER:
            if (
                ...
                and "booking.create" in station_permissions
            ):
                actions.append(
                    {
                        "type": "booking_form",
    ...
    async def _handle_escalation(
        ...
        return {
            ...
            "escalation": {
                ...
                "priority": (
                    "high"
                    if "legal" in escalation_check["triggers"]
                    else "normal"
                ),
            },
        }
