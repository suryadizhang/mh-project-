...
def cached(
    ttl: int = 300, key_prefix: str = "", key_builder: Callable | None = None
):
    """
    ...
    def decorator(func: Callable[P, T]) -> Callable[P, T]:
        ...
        async def wrapper(*args: P.args, **kwargs: P.kwargs) -> T:
            ...
            if cache_service:
                ...
                logger.info(
                    f"Invalidated {deleted} cache keys matching {pattern}"
                )
