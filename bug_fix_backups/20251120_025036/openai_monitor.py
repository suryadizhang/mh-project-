...
class APIKeyHealthStatus(BaseModel):
    ...
    available_models_count: int | None = None
...
class OpenAIKeyMonitor:
    ...
    def __init__(self, api_key: str):
        ...
        self._last_check: APIKeyHealthStatus | None = None
    ...
    async def validate_key(self, force: bool = False) -> APIKeyHealthStatus:
        ...
        if not force and self._last_check:
            time_since_check = (
                datetime.now(UTC) - self._last_check.last_checked
            )
        ...
        try:
            ...
            try:
                completion = self.client.chat.completions.create(
                    model="gpt-4o",  # GPT-4o for better monitoring insights
    ...
    def get_cached_status(self) -> APIKeyHealthStatus | None:
...
_monitor: OpenAIKeyMonitor | None = None


def get_monitor() -> OpenAIKeyMonitor | None:
