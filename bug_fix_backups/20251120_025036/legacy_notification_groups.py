...
class NotificationGroupEvent(Base):
    ...
    # Relationships
    group = relationship(
        "NotificationGroup", back_populates="event_subscriptions"
    )
...
DEFAULT_GROUPS = [
    ...
    },
    {
        ...
        "description": "QA team - receive review and complaint notifications",
        "station_id": None,
        "events": ["review_received", "complaint_received"],
    },
]

# Station-specific groups will be created dynamically per station
# Example: "Station CA-BAY-001 Managers" - only receives notifications for CA-BAY-001
