...
class TestRaceConditionFix:
    ...
    async def customer(self, db_session):
        ...
        NOTE: Using raw SQL because Customer model is out of sync with database schema.
        Database has email_encrypted/phone_encrypted/consent_sms/consent_email,
        but model has email/phone/email_notifications/sms_notifications.
        This is tracked as Phase 0 database migration issue.
        """
        import uuid
        ...
        # We need a station_id - create a minimal station first
        ...
        await db_session.execute(
            ...
            """),
            {
                ...
                "first_name": "Test",
                "last_name": "Customer",
                "email_encrypted": "test-race-condition@example.com",  # TODO: Should be encrypted
                "phone_encrypted": "+1234567890",  # TODO: Should be encrypted
                "consent_sms": True,
                "consent_email": True,
                "timezone": "America/New_York",
                "tags": [],
                "notes": "Test customer for Bug #13 race condition tests"
            }
        )
        await db_session.commit()
        
        # Return a minimal mock object with the ID for test usage
        class MockCustomer:
            def __init__(self, customer_id):
                self.id = customer_id
        
        return MockCustomer(customer_id)
