...
class CustomerTonePreference(Base):
    ...
    id = Column(String(36), primary_key=True)
    customer_id = Column(String(36), ForeignKey('customers.id', ondelete='CASCADE'), nullable=False)  # Removed public schema
...
class SyncHistory(Base):
    ...
    last_sync_time = Column(DateTime(timezone=True), default=lambda: datetime.now(timezone.utc), nullable=False)
