...
async def test_lead_creation():
    ...
    try:
        ...
        # Phase 2B: Updated\nfrom core.database import  # OLD: from api.app.database import get_db
        from services.lead_service import LeadService

        # Phase 2B: Updated\nfrom models.legacy_lead_newsletter import  # OLD: from api.app.models.lead_newsletter import LeadSource, LeadStatus, LeadQuality
        ...
        async for db in get_db():
            ...
            # Show breakdown
            print("\n   📊 Score Breakdown:")
            print("      • Source (web_quote): 20 points")
            print(f"      • Party size (12 guests): {min(12 * 2, 15)} points")
            print("      • Budget ($1,000-$2,000): ~15 points")
            print("      • Timing (future date): 15 points")
            print("      • Contact method (email): 5 points")
            ...
            print(
                f"      • Total estimated value: ${stats.get('total_estimated_value_dollars', 0):,.2f}"
            )
