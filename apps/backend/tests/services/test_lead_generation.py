...
async def test_lead_api():
    ...
    # OLD: from api.app.models.lead_newsletter import LeadSource
    ...
    async for db in get_db():
        ...
        if lead.score > 0:
            ...
            if lead.score >= 70:
                print("   Quality: HOT 🔥 (Score >= 70)")
            elif lead.score >= 40:
                print("   Quality: WARM ☀️ (Score 40-69)")
            else:
                print("   Quality: COLD ❄️ (Score < 40)")
            ...
            print("   - Timing: 15 points")
            print("   - Contact methods: 5 points (email)")
        else:
