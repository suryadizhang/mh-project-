"""
Role and Permission Models - RBAC System

Migrated from models_DEPRECATED_DO_NOT_USE/role.py
Updated to use modern SQLAlchemy 2.0 patterns and NEW base_class

Architecture:
- Schema: public (role management is cross-schema)
- Tables: roles, permissions, role_permissions
- Pattern: Many-to-many role-permission association
...
Enterprise Features:
- Comprehensive permission model (70+ permissions)
