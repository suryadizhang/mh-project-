...
class ReviewSubmissionRequest(BaseModel):
    ...
    complaint_text: Optional[str] = Field(None, description="Required for negative reviews")
    improvement_suggestions: Optional[str] = Field(None, description="How we can improve")
        ...
        "reviews": [
            {
                ...
                "submitted_at": review.submitted_at.isoformat() if review.submitted_at else None,
                "escalated_at": review.admin_notified_at.isoformat() if review.admin_notified_at else None,
                "coupon_issued": review.coupon_issued,
                "escalations": [
                    {
                        "id": str(esc.id),
