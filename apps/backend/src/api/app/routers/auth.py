                ...
                "application/json": {
                    "examples": {
                        ...
                        "account_locked": {
                            ...
                            "value": {"detail": "Account locked due to too many failed login attempts. Try again in 15 minutes."}
                        }
                    }
                }
            }
                ...
                "application/json": {
                    "examples": {
                        ...
                        "already_used": {
                            ...
                            "value": {"detail": "Refresh token has already been used. Please login again."}
                        }
                    }
                }
            }
...
@router.post(
    ...
    responses={
        ...
        429: {
            ...
            "content": {
                "application/json": {
                    "example": {"detail": "Too many password reset requests. Please try again in 1 hour."}
                }
            }
        }
    }
