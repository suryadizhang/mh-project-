...
class StationContext:
    ...
    def __init__(
        ...
        primary_station_id: Optional[UUID] = None,
        current_station_id: Optional[UUID] = None
    ):
    ...
    def get_role_for_station(self, station_id: UUID) -> Optional[StationRole]:
    ...
    def can_access_station(self, station_id: UUID) -> bool:
        ...
        return can_access_station(
            self.highest_role,
            station_id,
            list(self.accessible_station_ids)
        )
...
class StationAuthenticationService(BaseAuthenticationService):
    ...
    async def get_user_station_context(self, db: AsyncSession, user: User) -> Optional[StationContext]:
    ...
    def create_station_aware_jwt_tokens(
        ...
        target_station_id: Optional[UUID] = None
        ...
        refresh_payload = {
            ...
            'typ': 'refresh',
            'session_id': str(session_id),
            'primary_station_id': str(station_context.primary_station_id) if station_context.primary_station_id else None
        }
    ...
    def extract_station_context_from_token(self, token_payload: Dict[str, Any]) -> Optional[StationContext]:
        ...
        try:
            ...
            context.station_roles = {sid: station_context_data['station_role'] for sid in accessible_stations}
            context.station_permissions = {sid: set(station_context_data['station_permissions']) for sid in accessible_stations}
    ...
    async def switch_station_context(
        ...
        try:
            ...
            access_token, refresh_token, access_jti, refresh_jti = self.create_station_aware_jwt_tokens(
