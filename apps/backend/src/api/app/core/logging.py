...
def setup_logging(
    ...
    config: dict[str, Any] = {
        ...
        "formatters": {
            "standard": {"format": formats.get(format_type, formats["detailed"])},
            "json": {
        ...
        "loggers": {
            ...
            "fastapi": {"level": level, "handlers": ["console"], "propagate": False},
...
def setup_production_logging():
    ...
    setup_logging(level="INFO", log_file="/var/log/myhibachi/api.log", format_type="json")
    ...
    return {"error": error_logger, "access": access_logger, "security": security_logger}
