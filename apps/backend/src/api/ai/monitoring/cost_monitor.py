...
from .pricing import MONTHLY_ALERT_THRESHOLD, DAILY_ALERT_THRESHOLD
...
class CostMonitor:
    ...
    def __init__(self):
        ...
        self.monthly_threshold = float(os.getenv("API_COST_MONTHLY_THRESHOLD", MONTHLY_ALERT_THRESHOLD))
