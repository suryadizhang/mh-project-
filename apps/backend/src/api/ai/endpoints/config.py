...
class AIAPISettings:
    ...
    def __init__(self):
        ...
        self.enable_menu_recommendations = (
            os.getenv("ENABLE_MENU_RECOMMENDATIONS", "true").lower() == "true"
        )
        self.enable_human_escalation = (
            os.getenv("FEATURE_FLAG_HUMAN_ESCALATION", "true").lower() == "true"
        )
        ...
        self.ringcentral_server_url = os.getenv(
    ...
    def get_external_services_config(self) -> dict[str, Any]:
        ...
        return {
            ...
            "redis": {"enabled": self.redis_enabled, "url": self.redis_url},
        }
