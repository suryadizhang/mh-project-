...
def extract_station_context(authorization: Optional[str] = Header(None)) -> Optional[StationContext]:
    """
...
def get_station_context_optional(authorization: Optional[str] = Header(None)) -> Optional[StationContext]:
    """
...
def require_station_context(authorization: Optional[str] = Header(None)) -> StationContext:
    """
...
def has_permission(context: Optional[StationContext], permission: str) -> bool:
...
def has_agent_access(context: Optional[StationContext], agent: str) -> bool:
...
def get_station_filter(context: Optional[StationContext]) -> Dict[str, Any]:
