...
class ConnectionManager:
    ...
    async def connect(self, websocket: WebSocket, conversation_id: str, user_info: dict = None):
        ...
        try:
            ...
            await self.send_to_websocket(websocket, WebSocketMessage(
    ...
    async def send_ai_response(self, conversation_id: str, content: str, message_id: str = None, metadata: dict = None):
