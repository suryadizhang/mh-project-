...
class AIResponseCache:
    ...
    def __init__(self, redis_client=None):
        ...
        self.static_keywords = [
            "payment", "price", "cost", "pricing", "how much", "fee", "charge",
            "hours", "open", "close", "schedule", "location", "address", "phone",
            "email", "contact", "service area", "deliver", "available area"
        ]
        
        self.semi_static_keywords = [
            "menu", "food", "protein", "chicken", "beef", "shrimp", "salmon",
            "vegetarian", "vegan", "options", "include", "provide", "equipment"
        ]
        
        self.dynamic_keywords = [
            "available", "availability", "book", "reserve", "today", "tomorrow",
            "this week", "next week", "special", "promotion", "discount"
        ]
