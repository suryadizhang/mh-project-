...
class LocalLLMService:
    ...
    async def health_check(self) -> dict[str, Any]:
        ...
        try:
            ...
            logger.exception(f"Cannot connect to Ollama at {self.base_url}")
            return {
                "status": "unhealthy",
    ...
    async def generate_response(
        ...
        try:
            ...
            logger.exception(f"Ollama request timeout after {self.timeout}s")
            return {
                "success": False,
                "response": "",
...
# Singleton instance
_local_llm_service: LocalLLMService | None = None
