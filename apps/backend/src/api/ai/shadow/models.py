...
class AITutorPair(Base):
    ...
    quality_score = Column(
        Float,
        nullable=True,
        comment="Overall quality assessment (0-1)"
    )
...
class AIRLHFScore(Base):
    ...
    tone_score = Column(
        Integer,
        nullable=False,
        comment="Appropriate tone for brand? (1-5)"
    )
    ...
    overall_score = Column(
        Float,
        nullable=False,
        comment="Average of all scores (1-5)"
    )
...
class AIExportJob(Base):
    ...
    export_type = Column(
        String(50),
        nullable=False,
        comment="fine_tuning/evaluation/backup"
    )
    status = Column(
    ...
    min_rlhf_score = Column(
        Float,
        nullable=True,
        comment="Minimum RLHF score if available"
    )
