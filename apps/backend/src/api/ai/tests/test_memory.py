...
class MemoryBackendTests:
    ...
    async def test_escalation(self):
        ...
        try:
            ...
            await self.memory.update_conversation_metadata(conversation_id=conv_id, escalated=True)
    ...
    async def test_cross_channel(self):
        ...
        try:
            ...
            user_history = await self.memory.get_user_history(user_id=user_id, limit=10)
    ...
    async def test_context_window(self):
        ...
        try:
            ...
            context = await self.memory.get_context_window(
                conversation_id=conv_id, max_tokens=1000  # Should fit ~8-10 messages
            )
    ...
    async def test_conversation_lifecycle(self):
        ...
        try:
            ...
            await self.memory.update_conversation_metadata(
                conversation_id=conv_id, context={"booking_id": "BK123", "event_date": "2025-12-20"}
            )
