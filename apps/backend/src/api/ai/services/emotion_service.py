...
class EmotionService:
    ...
    NEGATIVE_EMOTIONS = [
        "anger", "frustration", "disappointment", "annoyance", 
        "irritation", "upset", "dissatisfaction", "complaint"
    ]
    
    NEUTRAL_EMOTIONS = [
        "curiosity", "inquiry", "confusion", "uncertainty", "interest"
    ]
    
    POSITIVE_EMOTIONS = [
        "joy", "excitement", "satisfaction", "happiness", "enthusiasm",
        "gratitude", "appreciation", "delight"
    ]
    ...
    async def detect_emotion(
        ...
        try:
            ...
            logger.info(
                f"Emotion detected: {label} (score: {score:.2f}, "
