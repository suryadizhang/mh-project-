    ...
    async def execute(self, **kwargs) -> ToolResult:
        ...
        try:
            ...
            if not customer_address and not customer_zipcode:
                return ToolResult(
                    success=False,
                    error="Either customer_address or customer_zipcode is required"
                )
            ...
            logger.info(
                f"Travel fee tool executed successfully",
                extra={
            ...
            logger.error(f"Travel fee tool execution failed: {str(e)}", exc_info=True)
            return ToolResult(
                success=False,
                error=f"Failed to calculate travel fee: {str(e)}",
