...
class QueryAnalyzer:
    ...
    def detect_n_plus_one(query: Select) -> dict:
        ...
        return {
            ...
            "recommendation": "Add eager loading if accessing relationships" if not has_eager_loading else "Good - using eager loading"
        }
...
def optimize_query(relationships: Optional[List[str]] = None, strategy: str = "selectinload"):
    """
