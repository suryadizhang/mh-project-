...
class ServiceRegistry:
    ...
    def configure_database(self, database_url: str, **engine_kwargs) -> "ServiceRegistry":
        ...
        engine_config = {"echo": False, "pool_pre_ping": True, "pool_recycle": 300, **engine_kwargs}
    ...
    def register_repositories(self) -> "ServiceRegistry":
        ...
        self.container.register_transient(
            "booking_repository", BookingRepository, dependencies={"session": "database_session"}
        )

        self.container.register_transient(
            "customer_repository", CustomerRepository, dependencies={"session": "database_session"}
        )
    ...
    def validate_registrations(self) -> bool:
        ...
        required_services = ["database_session", "booking_repository", "customer_repository"]
...
def create_service_container(
    database_url: str, app_config: dict[str, Any] | None = None
...
_global_container: DependencyInjectionContainer | None = None
