...
class SecureDataHandler:
    ...
    def decrypt_phone(self, encrypted_phone: Optional[str]) -> Optional[str]:
        ...
        try:
            ...
            logger.error(f"Invalid decryption token - possible wrong key or corrupted data: {e}")
...
_handler: Optional[SecureDataHandler] = None
