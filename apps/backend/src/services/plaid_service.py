    ...
    async def initiate_payment(
        ...
        try:
            ...
            payment_amount = PaymentAmount(
                value=float(amount),
                currency=PaymentAmountCurrency("USD")
            )
    ...
    async def get_payment_status(self, payment_id: str) -> Dict:
        ...
        try:
            ...
            return {
                ...
                "last_status_update": response.last_status_update.isoformat() + "Z" if hasattr(response, 'last_status_update') else None
            }
