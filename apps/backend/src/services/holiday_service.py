...
class USHolidayService:
    ...
    def _initialize_holidays(self) -> Dict[str, Holiday]:
        ...
        return {
            ...
            "graduation_season": Holiday(
                ...
                typical_events=["Graduation parties", "Family celebrations", "Achievement celebrations"]
            ),
            "fathers_day": Holiday(
                name="Father's Day",
                category=HolidayCategory.COMMERCIAL,
            ...
            "back_to_school": Holiday(
                ...
                typical_events=["Welcome back parties", "Teacher appreciation", "Student gatherings"]
            ),
            "halloween": Holiday(
                name="Halloween",
                category=HolidayCategory.COMMERCIAL,
            ...
            "christmas": Holiday(
                ...
                typical_events=["Christmas parties", "Office parties", "Family gatherings", "Holiday celebrations"]
            ),
    ...
    def get_current_holiday(self, check_date: Optional[date] = None) -> Optional[Tuple[str, Holiday, date]]:
        """
