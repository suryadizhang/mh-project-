...
class NotificationGroupService:
    ...
    async def get_group(self, group_id: UUID) -> Optional[NotificationGroup]:
    ...
    async def list_groups(
        ...
        if not include_inactive:
            conditions.append(NotificationGroup.is_active == True)
    ...
    async def list_group_members(
        ...
        if not include_inactive:
            query = query.where(NotificationGroupMember.is_active == True)
    ...
    async def remove_event_subscription(
        ...
        logger.info(f"✅ Removed event subscription")
