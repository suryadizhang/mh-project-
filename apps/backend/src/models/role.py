...
"""
from sqlalchemy import Column, String, Boolean, DateTime, Text, Table, ForeignKey, Enum as SQLEnum
...
user_roles = Table(
    'user_roles',
    Base.metadata,
    Column('user_id', UUID(as_uuid=True), ForeignKey('identity.users.id', ondelete='CASCADE'), primary_key=True),
    Column('role_id', UUID(as_uuid=True), ForeignKey('identity.roles.id', ondelete='CASCADE'), primary_key=True),
    Column('assigned_at', DateTime(timezone=True), default=datetime.utcnow),
    Column('assigned_by', UUID(as_uuid=True), ForeignKey('identity.users.id', ondelete='SET NULL'), nullable=True),
    schema='identity'
)
...
class Role(Base):
    ...
    created_by = Column(UUID(as_uuid=True), ForeignKey('identity.users.id', ondelete='SET NULL'), nullable=True)
