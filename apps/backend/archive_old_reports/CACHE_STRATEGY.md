...
**Purpose:** Guidelines for implementing caching in the MyHibachi
backend  
**Cache System:** Redis with TTL-based expiration + pattern-based
invalidation  
...
5. If not exists → execute function, cache result, return value (cache
   MISS)
...
No additional error handling needed in your code! If Redis fails,
...
**Questions?** Contact the backend team or refer to the cache service
source code.
