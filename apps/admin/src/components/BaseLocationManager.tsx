...
export function BaseLocationManager() {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setUpdateStatus({
          type: 'success',
          message:
            'Company settings updated successfully! Changes will apply to new quotes.',
        });
      } else {
  ...
  const hasChanges =
    JSON.stringify(currentSettings) !== JSON.stringify(formData);
      ...
      <div className="rounded-lg border border-gray-200 bg-white shadow">
        <div className="border-b border-gray-200 p-6">
          ...
          <p className="mt-1 text-sm text-gray-600">
            Configure travel fee structure and service area information for
            customer quotes
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                />
                <p className="mt-1 text-xs text-gray-500">
                  Cost per mile beyond free radius
                </p>
              </div>
              ...
              <div className="rounded-lg bg-blue-50 p-3">
                ...
                <div className="space-y-1 text-sm text-blue-800">
                  <p>
                    • 0-{formData.baseFeeStructure.freeRadius} miles:{' '}
                    <strong>Free</strong>
                  </p>
                  <p>
                    • Beyond {formData.baseFeeStructure.freeRadius} miles:{' '}
                    <strong>
                      ${formData.baseFeeStructure.ratePerMile}/mile
                    </strong>
                  </p>
                  <p>
                    • Example 50 miles: $
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={e =>
                    handleInputChange('serviceArea.description', e.target.value)
                  }
                  placeholder="e.g., Northern California, Bay Area..."
                  className="w-full rounded-md border border-gray-300 px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                />
                <p className="mt-1 text-xs text-gray-500">
                  General description shown to customers
                </p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">
                  Last Updated: {currentSettings.lastUpdated} by{' '}
...
function TravelFeeCalculator({ settings }: { settings: CompanySettings }) {
  ...
  const calculateFee = (miles: number) => {
    ...
    return (
      (miles - settings.baseFeeStructure.freeRadius) *
      settings.baseFeeStructure.ratePerMile
    );
  };
