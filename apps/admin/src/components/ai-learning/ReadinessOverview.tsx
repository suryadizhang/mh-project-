...
export function ReadinessOverview({ dashboard, onRefresh, isRefreshing }: ReadinessOverviewProps) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">AI Readiness Overview</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        ...
        <div className="relative">
          <div className="text-center">
            <div className={`text-5xl font-bold ${getScoreColor(overall_readiness.score)}`}>
              {overall_readiness.score}%
            </div>
            <div className="text-sm text-gray-600 mt-2">Overall Readiness</div>
          </div>
          <div className={`mt-4 px-4 py-2 rounded-lg border flex items-center gap-2 ${statusDisplay.color}`}>
            {statusDisplay.icon}
        ...
        <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg p-4">
          ...
          <div className="text-3xl font-bold text-purple-900">{overall_readiness.total_pairs_collected.toLocaleString()}</div>
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {overall_readiness.ready_intents.length > 0 ? (
              ...
              <span className="text-gray-500 text-sm italic">No intents ready yet</span>
            )}
          </div>
        </div>
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {overall_readiness.training_intents.length > 0 ? (
              ...
              <span className="text-gray-500 text-sm italic">No intents training</span>
            )}
          </div>
        </div>
      </div>
      ...
      {!overall_readiness.can_activate && overall_readiness.blocking_reasons.length > 0 && (
