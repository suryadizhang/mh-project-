            ...
            <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
              <div className="flex">
                ...
                <p className="text-sm text-yellow-800">
                  {warningMessage ||
                    `This ${resourceType} will be soft-deleted and can be restored within 30 days. After 30 days, it will be permanently removed.`}
                </p>
              </div>
            </div>
                ...
                <div id="reason-help" className="text-sm text-gray-600">
                  ...
                  {reason.length > 0 && reason.length < MIN_REASON_LENGTH && (
                    <span className="text-red-600">
                      {MIN_REASON_LENGTH - reason.length} more character
                      {MIN_REASON_LENGTH - reason.length !== 1 ? 's' : ''}{' '}
                      required
                    </span>
                  )}
                  {isReasonValid && (
