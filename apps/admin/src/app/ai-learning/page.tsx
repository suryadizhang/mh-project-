    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Monitor shadow learning progress, manage AI activation, and track
          quality metrics
        </p>
      </div>
                ...
                <div className="flex-1">
                  ...
                  {alert.metrics && (
                    <div className="mt-2 text-xs text-gray-600">
                      Similarity:{' '}
                      {((alert.metrics.current_similarity || 0) * 100).toFixed(
                        1
                      )}
                      %
                      {alert.metrics.threshold &&
                        ` (threshold: ${(alert.metrics.threshold * 100).toFixed(1)}%)`}
                    </div>
                  )}
                </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {Object.entries(dashboard.intent_breakdown).map(
            ([intent, readiness]) => (
              <div
                key={intent}
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-gray-900">
                      {readiness.pairs_collected} /{' '}
                      {readiness.min_pairs_required}
                    </span>
                  </div>
                  <div className="flex justify-between">
                ...
                {readiness.can_activate && (
                  <div className="mt-4 pt-4 border-t border-gray-200">
                    ...
                    <div className="flex justify-between text-xs text-gray-500 mt-1">
                      <span>0%</span>
                      <span>
                        {readiness.recommended_traffic_percent}% (recommended)
                      </span>
                      <span>100%</span>
                    </div>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-blue-50 rounded-lg p-4">
              ...
              <div className="text-2xl font-bold text-blue-900">
                {dashboard.quality_metrics.teacher_metrics.avg_response_time_ms.toFixed(
                  0
                )}
                ms
              </div>
            ...
            <div className="bg-green-50 rounded-lg p-4">
              ...
              <div className="text-2xl font-bold text-green-900">
                {dashboard.quality_metrics.student_metrics.avg_response_time_ms.toFixed(
                  0
                )}
                ms
              </div>
            ...
            <div className="bg-purple-50 rounded-lg p-4">
              ...
              <div className="text-2xl font-bold text-purple-900">
                {dashboard.quality_metrics.comparison.cost_savings_percent.toFixed(
                  1
                )}
                %
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <div className="text-lg font-semibold text-green-600">
                {(dashboard.ml_predictor_status.model_accuracy * 100).toFixed(
                  1
                )}
                %
              </div>
