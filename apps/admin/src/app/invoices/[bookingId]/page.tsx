...
export default function AdminInvoicePage() {
    ...
    const fetchBooking = async () => {
      ...
      try {
        ...
        const mockBooking: BookingData = {
          bookingId: bookingId,
          confirmationNumber: `MH${Math.random()
            .toString(36)
            .substr(2, 8)
            .toUpperCase()}`,
          ...
          services: [
            {
              ...
              description:
                'Full hibachi dining experience with chef performance',
              price: 55,
              quantity: 6,
  ...
  const calculateTax = () => {
    ...
    const subtotalAfterDiscount =
      subtotalWithTravel - invoiceSettings.discountAmount;
  ...
  const calculateBalanceDue = () => {
    ...
    const balanceDue =
      adjustedTotal -
      (invoiceSettings.depositPaid ? invoiceSettings.depositAmount : 0);
              ...
              <div className="space-y-3">
                ...
                <div className="pt-4 space-y-2">
                  ...
                  <p className="text-sm text-gray-500 italic">
                    * Final totals with travel fees, discounts, and tax are
                    calculated in the Payment Summary below
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-500">
                  Enter the deposit amount required (max: $
                ...
                <div className="space-y-1 text-sm">
                  ...
                  {invoiceSettings.travelMiles > 0 && (
                    <div className="flex justify-between text-blue-600">
                      <span>
                        Travel Fee ({invoiceSettings.travelMiles} mi × $2):
                      </span>
                  ...
                  {invoiceSettings.discountAmount > 0 && (
                    <div className="flex justify-between text-green-600">
                      <span>
                        Discount (
                        {invoiceSettings.discountDescription || 'Applied'}):
                      </span>
                  ...
                  {invoiceSettings.depositAmount > 0 && (
                    <div className="flex justify-between">
                      <span>
                        Deposit{' '}
                        {invoiceSettings.depositPaid ? '(Paid)' : '(Required)'}:
                      </span>
