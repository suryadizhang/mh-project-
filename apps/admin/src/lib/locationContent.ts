...
export const generateLocationPage = (location: string) => {
  ...
  const localKeywords = getHyperLocalKeywords().find(
...
function getLocationInfo(location: string) {
  const locationDatabase = {
    'San Francisco': {
      ...
      speciality:
        'Perfect for SF apartment parties, rooftop events, and urban celebrations',
      uniqueFeatures: [
    ...
    'San Jose': {
      ...
      speciality:
        'Specializing in tech company events and Silicon Valley celebrations',
      uniqueFeatures: [
    ...
    Oakland: {
      ...
      speciality:
        'Bringing hibachi shows to East Bay backyards and celebrations',
      uniqueFeatures: [
    ...
    'Mountain View': {
      ...
      speciality:
        'Specialized in Google area tech company and home celebrations',
      uniqueFeatures: [
    ...
    'Santa Clara': {
      ...
      speciality:
        'Perfect for Santa Clara University and corporate celebrations',
      uniqueFeatures: [
...
${locationData.uniqueFeatures
  .map(
    (feature: string) =>
      `**${feature}**: Professional expertise tailored to ${location} events`
  )
  .join('\n')}
