...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    imageAlt:
      'Birthday hibachi celebration with cake, balloons, and party atmosphere',
  },
  {
    id: 4,
  ...
  },
  {
    ...
    eventType: 'Retirement',
    image:
      '/images/blog/hayward-retirement-party-hibachi-career-achievements.svg',
    imageAlt:
  ...
  },
  {
    ...
    metaDescription:
      'Build powerful business relationships with Redwood City executive networking hibachi events. Professional atmosphere meets interactive entertainment.',
    image:
      '/images/blog/redwood-city-executive-networking-hibachi-business.svg',
    imageAlt:
  ...
  // Month 5: Niche Market Content
  {
    ...
    image:
      '/images/blog/foster-city-sports-victory-celebration-hibachi-championship.svg',
    imageAlt:
  ...
  },
  {
    ...
    eventType: 'Block Party',
    image:
      '/images/blog/cupertino-block-party-hibachi-neighborhood-community.svg',
    imageAlt:
  ...
  },
  {
    ...
    image:
      '/images/blog/campbell-cultural-festival-hibachi-diversity-celebration.svg',
    imageAlt:
  ...
  },
  {
    ...
    eventType: 'Wine Tasting',
    image:
      '/images/blog/saratoga-wine-tasting-hibachi-sophisticated-pairing.svg',
    imageAlt:
  ...
  },
  {
    ...
    image:
      '/images/blog/santa-clara-university-research-celebration-hibachi-academic.svg',
    imageAlt:
  ...
  },
  {
    ...
    image:
      '/images/blog/morgan-hill-winery-wedding-hibachi-vineyard-romance.svg',
    imageAlt:
  ...
  // Month 6: Premium Experience Content
  {
    ...
    image:
      '/images/blog/los-gatos-executive-retreat-hibachi-c-suite-team-building.svg',
    imageAlt:
  ...
  },
  {
    ...
    image:
      '/images/blog/gilroy-food-festival-garlic-capital-hibachi-integration.svg',
    imageAlt:
  ...
  },
  {
    ...
    eventType: 'VC Dinner',
    image:
      '/images/blog/mountain-view-venture-capital-dinner-hibachi-silicon-valley.svg',
    imageAlt:
  ...
  },
  {
    ...
    eventType: 'Sports Victory',
    image:
      '/images/blog/santa-clara-sports-team-celebration-hibachi-victory-championship.svg',
    imageAlt:
  ...
  },
  {
    ...
    image:
      '/images/blog/sunnyvale-international-festival-hibachi-global-celebrations.svg',
    imageAlt:
  ...
  },
  {
    ...
    featured: true,
    image:
      '/images/blog/bay-area-ultimate-hibachi-experience-luxury-entertainment.svg',
    imageAlt:
...
export const getPostsByServiceArea = (area: string): BlogPost[] => {
  return blogPosts.filter(
    post => post.serviceArea === area || post.serviceArea === 'All Areas'
  );
};
...
export const getAllServiceAreas = (): string[] => {
  const areas = Array.from(new Set(blogPosts.map(post => post.serviceArea)));
  return areas.sort();
};

export const getAllEventTypes = (): string[] => {
  const events = Array.from(new Set(blogPosts.map(post => post.eventType)));
  return events.sort();
};
