 ...
 */
function hasPermission(userRole: UserRole | null, allowedRoles: readonly UserRole[]): boolean {
...
export function usePermissions(): Permissions {
  ...
  // @ts-ignore - stationContext may have role property
  ...
  const permissions = useMemo<Permissions>(() => {
    ...
    const hasAnyRole = (roles: UserRole[]): boolean => userRole ? roles.includes(userRole) : false;
    ...
    return {
      ...
      canViewStationBookings: hasPermission(userRole, PERMISSIONS.BOOKING_VIEW_STATION),
      ...
      canViewStationChefs: hasPermission(userRole, PERMISSIONS.CHEF_VIEW_STATION),
      ...
      canManageOwnStation: hasPermission(userRole, PERMISSIONS.STATION_MANAGE_OWN),
      ...
      canAccessFinancialReports: hasPermission(userRole, PERMISSIONS.FINANCIAL_REPORTS),
      ...
      // System Permissions
      canAccessSystemSettings: hasPermission(userRole, PERMISSIONS.SYSTEM_SETTINGS),
      canAccessSystemAnalytics: hasPermission(userRole, PERMISSIONS.SYSTEM_ANALYTICS),
      canAccessStationAnalytics: hasPermission(userRole, PERMISSIONS.SYSTEM_ANALYTICS_STATION),
