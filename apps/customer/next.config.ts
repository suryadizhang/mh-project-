        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              // CRITICAL: API URL (both prod and staging), Google Maps Places API, Stripe, Analytics
              "connect-src 'self' https://*.mysticdatanode.net https://maps.googleapis.com https://www.google-analytics.com https://api.stripe.com https://vitals.vercel-insights.com https://cdn.jsdelivr.net ws://localhost:8002 http://localhost:8002",
