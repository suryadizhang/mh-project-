...
export const faqs: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      'For premium protein upgrades: Salmon, Scallops, and Filet Mignon are +${{SALMON_UPGRADE}} per person, while Lobster Tail is +${{LOBSTER_UPGRADE}} per person. These upgrade your existing protein choices to premium options.',
    category: 'Menu & Upgrades',
    subcategory: 'Premium Upgrades',
    tags: [
      'upgrades',
      'salmon +${{SALMON_UPGRADE}}',
      'scallops +${{SCALLOPS_UPGRADE}}',
      'filet +${{FILET_UPGRADE}}',
      'lobster +${{LOBSTER_UPGRADE}}',
      'premium proteins',
    ],
    confidence: 'high',
    source_urls: ['/menu'],
  ...
  },
  {
    ...
    answer:
      '⚠️ IMPORTANT: We do NOT provide tables or chairs! You provide: tables (U-shape recommended), chairs for all guests, plates, utensils, glasses, beverages (except sake), napkins, and a covered backup area in case of rain. We bring: hibachi grill, all food ingredients, cooking tools, propane, safety equipment, fire extinguisher, and sake for adults 21+. 💡 Need rental recommendations? Contact cs@myhibachichef.com for party rental company suggestions in your area.',
    category: 'On‑Site Setup & Requirements',
  ...
  },
  {
    ...
    answer:
      '⛈️ CUSTOMER RESPONSIBILITY: You MUST provide overhead covering (tent, patio cover, gazebo, garage, or indoor space) in case of rain or strong winds. ❌ NO REFUND if you fail to provide covered setup and weather prevents cooking. ✅ If we cancel due to unsafe conditions (lightning, severe storms), we offer one free reschedule. Our chef reserves the right to stop service if conditions become unsafe (winds over 25 mph, lightning). Always have a backup covered location ready!',
    category: 'Policies (Cancellation, Weather, Refunds)',
  ...
  {
    id: 'property-damage',
    question: 'Who is responsible for property damage during cooking?',
    answer:
      '⚠️ CUSTOMER RESPONSIBILITY: Hibachi cooking involves high heat, oil, and open flame which may cause smoke, grease splatter, heat marks on surfaces, or grass discoloration under the grill. Customer is responsible for selecting an appropriate cooking location and protecting surfaces if concerned (use heat-resistant mats or covers). We are NOT liable for damage to patios, decks, grass, flooring, ceilings, or walls from normal cooking operations. If your event is at a rented venue, you must obtain venue approval for open-flame cooking and are responsible for any damage deposits.',
    category: 'Policies (Cancellation, Weather, Refunds)',
  ...
  {
    id: 'media-release',
    question: 'Do you take photos/videos at events?',
    answer:
      '📸 YES! By booking with us, you grant permission for our chef to take photos and videos during your event for use on our website, social media (Instagram, Facebook, TikTok), and marketing materials. We feature customer events and testimonials (first name only unless you authorize full name). 🚫 OPT-OUT: If you prefer no photography, email cs@myhibachichef.com at least 24 hours before your event. Photos of minor children require visible parental approval.',
    category: 'Policies (Cancellation, Weather, Refunds)',
    subcategory: 'Media & Photography',
    tags: ['photos', 'videos', 'media release', 'social media', 'marketing', 'opt-out', 'privacy'],
    confidence: 'high',
    source_urls: ['/book-us/'],
  },
  {
    id: 'tables-chairs-rental',
    question: 'Do you provide tables and chairs?',
    answer:
      "❌ NO, we do NOT provide tables, chairs, plates, utensils, or tableware. This is the customer's responsibility. We recommend U-shape table arrangement with the chef's grill at the open end. Two 8-foot tables seat ~10 people, three 6-foot tables handle 12-15 guests. 💡 Need rental recommendations? Contact cs@myhibachichef.com and we can recommend party rental companies in your area for tables, chairs, linens, and tableware.",
    category: 'On‑Site Setup & Requirements',
    subcategory: 'Tableware & Setup',
    tags: [
      'tables',
  ...
  // Additional Popular Questions Based on Competitor Analysis
  {
    ...
    answer:
      'Yes! Each guest normally gets 2 proteins, but you can add an extra protein for +${{EXTRA_PROTEIN}} each. This is an additional option that gives you more food, not an upgrade. If you want the extra protein to be a premium option (Salmon, Scallops, Filet Mignon, or Lobster Tail), that would be the +${{EXTRA_PROTEIN}} for the additional protein plus the premium upgrade cost (+${{SALMON_UPGRADE}} for Salmon/Scallops/Filet Mignon, +${{LOBSTER_UPGRADE}} for Lobster Tail). Contact us at cs@myhibachichef.com to customize your menu.',
    category: 'Menu & Upgrades',
    subcategory: 'Add‑ons & Sides',
    tags: ['extra protein', 'additional protein', 'add-on', '+${{EXTRA_PROTEIN}}', 'more food'],
    confidence: 'high',
    source_urls: ['/menu'],
  },
  {
    ...
    answer:
      'We offer several delicious add-on options: Yakisoba Noodles (Japanese-style lo mein), Extra Fried Rice, Extra Vegetables (mixed seasonal vegetables), and Edamame (steamed soybeans with sea salt) are all +${{YAKISOBA_NOODLES}} each. Gyoza (pan-fried Japanese dumplings) is +${{GYOZA}} and Extra Protein (add additional proteins to your meal) is +${{EXTRA_PROTEIN}} each. These can be ordered per person or shared family-style.',
    category: 'Menu & Upgrades',
    subcategory: 'Add‑ons & Sides',
    tags: [
      'enhancements',
      'add-ons',
      'yakisoba noodles +${{YAKISOBA_NOODLES}}',
      'extra rice +${{EXTRA_FRIED_RICE}}',
      'extra vegetables +${{EXTRA_VEGETABLES}}',
      'edamame +${{EDAMAME}}',
      'gyoza +${{GYOZA}}',
      'extra protein +${{EXTRA_PROTEIN}}',
      'sides',
    ],
    confidence: 'high',
    source_urls: ['/menu'],
