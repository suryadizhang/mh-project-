    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div style="background-color: #fff3cd; border: 1px solid #ffc107; border-radius: 8px; padding: 16px; margin: 20px 0;">
                <h3 style="color: #856404; margin-top: 0;">⚠️ Important Health Notice</h3>
                <p style="color: #856404; margin-bottom: 0;">To protect all guests, anyone who has experienced <strong>vomiting, diarrhea, or fever within the past 48 hours</strong> should NOT attend the event. Norovirus and other stomach bugs spread extremely easily at gatherings. If you need to reschedule due to illness in your group, we offer flexible rescheduling options—just contact us.</p>
            </div>
...
To protect all guests, anyone who has experienced vomiting, diarrhea, or fever within the past 48 hours should NOT attend the event. If you need to reschedule due to illness, we offer flexible options—just contact us.
...
Planning another event? Visit myhibachichef.com to book again!

With gratitude,
The MyHibachi Team
myhibachichef.com | (123) 456-7890`;
