...
export const PAGE_SEO = {
  ...
  menu: {
    ...
    description:
      'Explore our authentic hibachi menu featuring premium steaks, fresh seafood, and traditional Japanese teppanyaki. Customizable packages for all events. View pricing and book your mobile hibachi experience.',
    keywords: [
      'hibachi menu',
      'teppanyaki pricing',
  ...
  booking: {
    ...
    description:
      'Book premium hibachi catering for your event. Easy online booking for Bay Area, Sacramento, San Jose. Professional mobile teppanyaki chefs for birthdays, weddings, corporate events.',
    keywords: [
  ...
  quote: {
    ...
    description:
      'Get instant free quote for hibachi catering. Professional pricing calculator for Bay Area, Sacramento, San Jose events. Custom packages for birthdays, weddings, corporate gatherings.',
    keywords: [
  ...
  contact: {
    ...
    description:
      'Contact My Hibachi Chef for premium mobile hibachi catering. Serving Bay Area, Sacramento, San Jose. Call (916) 740-8768 or message us for instant booking assistance.',
    keywords: [
  ...
  blog: {
    ...
    description:
      'Complete hibachi catering guides for every event: birthdays, weddings, corporate events, pool parties. Expert tips for Bay Area, Sacramento, San Jose celebrations.',
    keywords: [
  ...
  faqs: {
    ...
    description:
      'Get answers to common hibachi catering questions. Learn about pricing, setup, menu options, service areas, and booking process for Bay Area & Sacramento mobile hibachi.',
    keywords: [
  ...
  locations: {
    ...
    description:
      'Professional hibachi catering serving Bay Area, Sacramento, San Jose, Oakland, Fremont, and surrounding areas. Mobile teppanyaki chefs available for all locations.',
    keywords: [
...
export function generateServiceSchema() {
  return {
    ...
    description:
      'Professional mobile hibachi catering service bringing authentic Japanese teppanyaki experience to your location',
    provider: {
      '@type': 'Organization',
      name: SITE_CONFIG.name,
      url: SITE_CONFIG.url
