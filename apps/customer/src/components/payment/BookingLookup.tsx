  ...
  return (
    <div className="rounded-xl bg-white p-6 shadow-lg">
      ...
      <div className="mb-4">
        ...
        <div className="flex space-x-2">
          ...
          <button
            ...
            disabled={isLoading}
            className="flex items-center rounded-lg bg-red-600 px-6 py-3 text-white transition-colors hover:bg-red-700 disabled:cursor-not-allowed disabled:opacity-50"
          >
            {isLoading ? (
      ...
      {foundBooking && (
        <div className="mt-4 rounded-lg border border-green-200 bg-green-50 p-4">
          ...
          <div className="mt-3 border-t border-green-200 pt-3">
            <div className="mb-1 text-xs tracking-wide text-green-600 uppercase">
              Payment Status
            </div>
      ...
      <div className="mt-6 rounded-lg border border-blue-200 bg-blue-50 p-4">
        <h4 className="mb-2 text-sm font-medium text-blue-900">Demo Booking IDs for Testing:</h4>
        <div className="space-y-1 text-xs text-blue-700">
          <div>
            • <code className="rounded bg-blue-100 px-1">MH-20250830-AB12</code> - No deposit paid
          </div>
          <div>
            • <code className="rounded bg-blue-100 px-1">MH-20250825-CD34</code> - Deposit paid
          </div>
          <div>
            • <code className="rounded bg-blue-100 px-1">MH-20250828-EF56</code> - Deposit paid
          </div>
        </div>
        <div className="mt-2 text-xs text-blue-600">
          Or try email: <code className="rounded bg-blue-100 px-1">john.smith@email.com</code>
        </div>
      </div>
    </div>
  );
