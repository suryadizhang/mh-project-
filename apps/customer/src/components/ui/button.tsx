  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        // My Hibachi Brand Variants
        gradient:
          'bg-gradient-to-r from-red-600 to-red-700 text-white font-bold shadow-lg hover:from-red-700 hover:to-red-800 hover:shadow-xl transform hover:-translate-y-0.5 active:translate-y-0',
        'gradient-outline':
          'border-2 border-red-600 text-red-600 font-semibold bg-transparent hover:bg-red-600 hover:text-white transition-colors',
        'gradient-gold':
          'bg-gradient-to-r from-amber-500 to-orange-600 text-white font-bold shadow-lg hover:from-amber-600 hover:to-orange-700 hover:shadow-xl',
      },
      size: {
