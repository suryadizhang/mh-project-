  ...
  return (
    <div className={styles.container}>
      ...
      <div className="mb-4 space-y-2">
        <div className={styles.summaryBox}>
          <div className={styles.summaryText}>
            ...
            <button type="button" className={styles.editButton} onClick={onEditContact}>
              Edit
            </button>
          </div>
        </div>
        <div className={styles.summaryBox}>
          <div className={styles.summaryText}>
            ...
            <button type="button" className={styles.editButton} onClick={onEditVenue}>
              Edit
            </button>
          </div>
        </div>
      ...
      <div className={styles.section}>
        ...
        <p className={styles.description}>How many guests will be at your hibachi event?</p>
        ...
        <div className={variant === 'booking' ? 'form-group' : ''}>
          ...
          <input
            ...
            placeholder="e.g., 10"
          />
          {errors.guestCount && <div className={styles.errorText}>{errors.guestCount.message}</div>}
