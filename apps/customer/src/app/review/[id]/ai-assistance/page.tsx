...
export default function AIAssistancePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-red-50 px-4 py-12">
      <div className="mx-auto max-w-4xl">
        ...
        >
          ...
          <h1 className="mb-2 text-4xl font-bold text-gray-800">Let&apos;s Make This Right</h1>
          ...
          {!chatEnded ? (
            ...
            <div className="border-t border-gray-200 bg-green-50 p-6">
              <div className="text-center">
                ...
                <h3 className="mb-2 text-xl font-semibold text-gray-800">Issue Resolved!</h3>
        ...
        >
          ...
          <p className="text-sm text-gray-700">
            ...
            attention, it will automatically escalate to our customer service team. Your
