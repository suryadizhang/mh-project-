      ...
      <div className="container">
        <div className="privacy-content">
          ...
          <section className="privacy-section privacy-overview">
            ...
            <p>
              my Hibachi LLC (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;) is committed to protecting your privacy and ensuring the security of your personal information. This Privacy Policy explains how we collect, use, and safeguard your information when you use our hibachi catering services.
            </p>
          ...
          <section className="privacy-section sms-privacy-section">
            ...
            <div className="sms-consent-notice">
              ...
              <p className="consent-statement">
                <strong>By providing your phone number and opting into SMS communications, you consent to receive text messages from my Hibachi LLC regarding your bookings and our services.</strong>
              </p>
            </div>
            <h3>SMS Data Collection:</h3>
            <ul>
              <li><strong>Phone Number:</strong> Required for booking confirmations and event coordination</li>
              <li><strong>Booking Information:</strong> Event details, dates, and guest preferences</li>
              <li><strong>Communication Preferences:</strong> Your SMS communication settings and opt-in status</li>
              <li><strong>Response Data:</strong> Your replies to our messages for service improvement</li>
            </ul>
            <h3>SMS Usage:</h3>
            <ul>
            ...
            <div className="sms-privacy-controls">
              ...
              <ul>
                <li><strong>Opt-Out:</strong> Text <code>STOP</code> to unsubscribe at any time</li>
                <li><strong>Data Retention:</strong> SMS data is kept only as long as necessary for service delivery</li>
                <li><strong>Third-Party Sharing:</strong> We do not share your SMS consent with third parties</li>
                <li><strong>Frequency Control:</strong> Message frequency varies based on your bookings</li>
              </ul>
            </div>
          </section>
          <section className="privacy-section">
            ...
            <ul>
              ...
              <li><strong>Event Details:</strong> Event date, location, guest count, menu preferences</li>
              <li><strong>Payment Information:</strong> Credit card details, billing address (processed securely through Stripe)</li>
              <li><strong>Dietary Information:</strong> Food allergies, dietary restrictions, and special requests</li>
              <li><strong>Communication Records:</strong> Email correspondence, SMS messages, phone call notes</li>
            </ul>
            <h3>1.2 Automatically Collected Information</h3>
            <ul>
              <li><strong>Website Usage:</strong> IP address, browser type, pages visited, time spent on site</li>
              <li><strong>Device Information:</strong> Device type, operating system, unique device identifiers</li>
              <li><strong>Location Data:</strong> General location for service delivery (when explicitly provided)</li>
          ...
          <section className="privacy-section">
            ...
            <p>We may share your information with trusted service providers who help us operate our business:</p>
            <ul>
              <li><strong>Payment Processing:</strong> Stripe (for secure credit card processing)</li>
              <li><strong>Communication Services:</strong> SMS and email service providers</li>
              <li><strong>Cloud Storage:</strong> Secure data hosting and backup services</li>
              <li><strong>Analytics:</strong> Website performance and user experience tools</li>
              <li><strong>Legal Services:</strong> Attorneys and accountants (when necessary)</li>
            </ul>
          ...
          <section className="privacy-section">
            ...
            <ul>
              ...
              <li><strong>Secure Payment Processing:</strong> PCI DSS compliant payment handling through Stripe</li>
              ...
              <li><strong>Secure Communication:</strong> Protected SMS and email transmission</li>
            </ul>
          ...
          <section className="privacy-section">
            ...
            <ul>
              <li><strong>View Your Data:</strong> Request a copy of all personal information we have about you</li>
              <li><strong>Update Information:</strong> Correct or update your contact and event details</li>
            ...
            <ul>
              <li><strong>Account Deletion:</strong> Request complete removal of your personal information</li>
              <li><strong>Selective Deletion:</strong> Remove specific data points or communication records</li>
              <li><strong>Retention Limits:</strong> We automatically delete old data according to our retention policy</li>
            </ul>
          ...
          <section className="privacy-section">
            ...
            <ul>
              <li><strong>Active Customers:</strong> Information retained while you&apos;re an active customer</li>
              <li><strong>Booking Records:</strong> 7 years for tax and business record purposes</li>
              <li><strong>Payment Information:</strong> Minimal retention as required by payment processors</li>
              <li><strong>Communication Records:</strong> 3 years for customer service quality</li>
              <li><strong>Marketing Data:</strong> Until you opt-out or request deletion</li>
            </ul>
            <h3>6.2 Automatic Deletion</h3>
            <p>
              We automatically delete or anonymize personal information when it&apos;s no longer needed for business purposes, legal compliance, or legitimate interests.
            </p>
          </section>
          <section className="privacy-section">
          ...
          <section className="privacy-section">
            ...
            <p>
              Our website may contain links to third-party websites or services. We are not responsible for the privacy practices of these external sites. We encourage you to read their privacy policies before providing any personal information.
            </p>
          </section>
          <section className="privacy-section">
          ...
          <section className="privacy-section">
            ...
            <p>
              Your information may be processed and stored in the United States. By using our services, you consent to the transfer of your information to the U.S., where privacy laws may differ from your jurisdiction.
            </p>
          </section>
          <section className="privacy-section">
            ...
            <p>
              Your continued use of our services after changes become effective indicates acceptance of the updated Privacy Policy.
            </p>
          </section>
          ...
          <section className="privacy-section">
            <div className="privacy-commitment">
              <p><strong>Our Commitment: We are dedicated to protecting your privacy and will continue to implement best practices as technology and regulations evolve. Your trust is essential to our business.</strong></p>
            </div>
          </section>
        </div>
      </div>
