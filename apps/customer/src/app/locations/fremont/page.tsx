...
export const metadata: Metadata = {
  ...
  keywords:
    'Fremont hibachi catering, hibachi chef Fremont, East Bay hibachi, Fremont party catering, private hibachi chef Fremont, Fremont birthday hibachi, family hibachi Fremont, Fremont wedding hibachi',
  openGraph: {
    title: locationData.title,
    description: locationData.metaDescription,
    type: 'website',
            ...
            {locationData.content.services.map((service, index) => (
              <div key={index} className="bg-white p-6 rounded-lg shadow-sm text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Professional hibachi entertainment for your Fremont celebration
                </p>
              </div>
            ))}
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div
            ...
            dangerouslySetInnerHTML={{
              __html: locationContentBlocks.whyChooseUs('Fremont').replace(/\n/g, '<br />')
            }}
          />
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4">
          <div
            className="prose prose-lg max-w-none"
            dangerouslySetInnerHTML={{
              __html: locationContentBlocks.popularEvents('Fremont').replace(/\n/g, '<br />')
            }}
          />
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4">
          <div
            className="prose prose-lg max-w-none"
            dangerouslySetInnerHTML={{
              __html: locationContentBlocks.serviceAreas('Fremont').replace(/\n/g, '<br />')
            }}
          />
        </div>
      </section>
