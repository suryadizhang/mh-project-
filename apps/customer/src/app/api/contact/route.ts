  ...
  return NextResponse.json(
    {
      ...
      migration: {
        from: '/contact',
        to: `${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8000'}/api/contact`,
        status: 'MIGRATED',
