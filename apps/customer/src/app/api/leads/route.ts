...
export async function POST(request: NextRequest) {
  try {
    ...
    if (body.context) {
      ...
      if (
        context.party_size_adults !== undefined &&
        (typeof context.party_size_adults !== 'number' || context.party_size_adults < 0)
      ) {
        return NextResponse.json(
      ...
      if (
        context.party_size_kids !== undefined &&
        (typeof context.party_size_kids !== 'number' || context.party_size_kids < 0)
      ) {
        return NextResponse.json(
      ...
      if (
        context.estimated_budget_dollars !== undefined &&
        (typeof context.estimated_budget_dollars !== 'number' ||
          context.estimated_budget_dollars < 0)
      ) {
        return NextResponse.json(
