  ...
  return NextResponse.json(
    {
      ...
      migration: {
        from: '/v1/chat',
        to: `${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8000'}/api/v1/chat`,
        status: 'MIGRATED',
