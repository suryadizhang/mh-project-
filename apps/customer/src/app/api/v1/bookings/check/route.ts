 ...
 *
 * OLD: /v1/bookings/check
 * NEW: ${NEXT_PUBLIC_API_URL}/api/v1/bookings/check
 *
 * This stub returns HTTP 410 Gone to indicate permanent migration.
 * Update your frontend code to use the new backend endpoint.
 *
 * Migration Date: 2025-09-02T05:45:43.907Z
 * Backend Route: FastAPI backend - /api/v1/bookings/check
 */
  ...
  return NextResponse.json(
    {
      ...
      migration: {
        from: '/v1/bookings/check',
        to: `${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8000'}/api/v1/bookings/check`,
        status: 'MIGRATED',
