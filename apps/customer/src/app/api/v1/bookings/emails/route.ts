 ...
 *
 * OLD: /v1/bookings/emails
 * NEW: ${NEXT_PUBLIC_API_URL}/api/v1/bookings/emails
 *
 * This stub returns HTTP 410 Gone to indicate permanent migration.
 * Update your frontend code to use the new backend endpoint.
 *
 * Migration Date: 2025-09-02T05:45:43.908Z
 * Backend Route: FastAPI backend - /api/v1/bookings/emails
 */
  ...
  return NextResponse.json(
    {
      ...
      migration: {
        from: '/v1/bookings/emails',
        to: `${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8000'}/api/v1/bookings/emails`,
        status: 'MIGRATED',
