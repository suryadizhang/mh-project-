  ...
  return NextResponse.json(
    {
      ...
      migration: {
        from: '/assistant',
        to: `${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8000'}/api/assistant`,
        status: 'MIGRATED',
