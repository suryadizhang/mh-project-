...
class ToolRegistryService:
    ...
    def _initialize_agent_permissions(self) -> Dict[str, Dict[str, ToolPermissionLevel]]:
        ...
        return {
            ...
            "admin": {
                ...
                **{tool: ToolPermissionLevel.ADMIN for tool in [
                    "booking_search", "booking_create", "booking_modify", 
                    "booking_cancel", "booking_admin", "menu_query", "restaurant_info",
                    "user_create", "user_modify", "user_lookup", "customer_lookup", 
                    "customer_history", "staff_manage", "shift_management", "workflow_guide",
                    "analytics_query", "report_generator", "chart_creator", "data_export", 
                    "query_builder", "financial_reports", "system_config", "ticket_create", 
                    "escalation_route", "issue_tracking"
                ]}
            },
    ...
    def _has_sufficient_permission(
        self,
        agent_permission: ToolPermissionLevel,
            ...
            for agent, permissions in self.agent_permissions.items():
                ...
                if agent_permission != ToolPermissionLevel.FORBIDDEN:
                    authorized_agents.append({
                        "agent": agent,
                        "permission": agent_permission.value
                    })
