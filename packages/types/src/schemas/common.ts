...
export const BaseResponseSchema = z.object({
  ...
  timestamp: z
    ...
    .optional()
    .describe(
      'ISO 8601 timestamp of the response (OPTIONAL - not all endpoints use this)'
    ),
  requestId: z
    .string()
    .uuid()
    .optional()
    .describe(
      'Unique identifier for request tracing (OPTIONAL - not all endpoints use this)'
    ),
});
...
export function ApiResponseSchema<T extends z.ZodType>(dataSchema: T) {
  return BaseResponseSchema.extend({
    ...
    message: z.string().optional().describe('Optional user-friendly message'),
  });
}
...
export const MetadataSchema = z.object({
  version: z.string().optional().describe('Optional: API version'),
  environment: z
