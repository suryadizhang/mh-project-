  ...
  data: z
    .object({
      bookedDates: z
        .array(z.string())
        .describe(
          'Array of booked dates (ISO date strings or YYYY-MM-DD format)'
        ),
    })
      ...
      timeSlots: z
        .array(
          z.object({
            time: z
              .string()
              .describe('Time slot in HH:MM format (e.g., "17:00")'),
            available: z
              .number()
              .int()
              .nonnegative()
...
export const AvailableTimesResponseSchema = z.object({
  ...
  data: z
    .object({
      date: z.string().describe('The date for which times are being checked'),
      times: z
        .array(
          z.object({
            ...
            available: z
              .boolean()
              .describe('Whether this time slot is available'),
      ...
      count: z
        ...
        .nonnegative()
        .optional()
        .describe('Total time slots'),
    })
    .describe('Available times data'),
  error: z.string().optional().describe('Error message if success is false'),
});

export type AvailableTimesResponse = z.infer<
  typeof AvailableTimesResponseSchema
>;
  ...
  data: z
    .object({
      ...
      code: z
        ...
        .optional()
        .describe(
          'Error code for specific failure scenarios (e.g., "SLOT_FULL", "BOOKING_ERROR")'
        ),
    })
    .optional()
...
export const BookingDetailResponseSchema = z.object({
  ...
  data: z
    .object({
      ...
      canModify: z.boolean().describe('Whether the booking can be modified'),
      canCancel: z.boolean().describe('Whether the booking can be cancelled'),
      modifications: z
        .array(
          z.object({
            modifiedAt: z
            ...
            modifiedBy: z.string().describe('User who made the modification'),
            changes: z
              .record(z.any())
